%% Concave hull from a 2D gridded point set with a cavity

%% Introduction
% In this example, a 2-dimensional gridded point set is given, which has an
...
d=2;
%% 
% Define the gridded point set 1, which includes the cavity formed by the
% point set 2.
[X,Y]=meshgrid(0:0.1:1);
points1=[X(:),Y(:)];
%% 
% Perform random permutations to point set 1.
points1=points1+0.001*rand(size(points1));
%%
